...
<script>
  export default {
    data() {
      return {
        projects: [
          { title: 'Catherine Cookson Charitable Trust', summary: 'Responsive website and content management system for Catherine Cookson Charitable Trust.', url: '/projects/catherine-cookson-charitable-trust/', isNew: true, images: { header: '/images/projects/catherine-cookson-charitable-trust/header.jpg', desktopPreview: '/images/projects/catherine-cookson-charitable-trust/screenshot-desktop.jpg', mobilePreview: '/images/projects/catherine-cookson-charitable-trust/screenshot-mobile.jpg' }, brandColour: '#3a0ca3' },
          { title: 'Fat Hippo', summary: 'Website redevelopment and search engine optimasation for burger restaurant chain.', url: '/projects/fat-hippo/', isNew: false, images: { header: '/images/projects/fat-hippo/header.jpg', desktopPreview: '/images/projects/fat-hippo/screenshot-desktop.jpg', mobilePreview: '/images/projects/fat-hippo/screenshot-mobile.jpg' }, brandColour: '#000' },
