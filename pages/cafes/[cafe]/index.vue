<template>
  <main id="main">
    ...
    <section id="similar" class="section section--shade">
      <div class="inner">
        <div class="flex-container">
          <div class="section__title font-medium">Similar Cafes in [Location Name]</div>
          <div class="section__action">
            <NuxtLink to="/cafes/">View All</NuxtLink>
          </div>
        </div>
      </div>
    </section>
