<template>
  <main id="main" class="main">
    ...
    <section class="section section--padding">
      <div class="inner inner--narrow article">
        <header class="article__header">
          <h1 class="article__title font-xl">{{ page.title }}</h1>
          <div class="article__details">Posted on {{ page.date }} by {{ page.author }}</div>
        </header>
        ...
        <div class="article__content">
          <p v-if="page.abstract" class="font-medium">{{ page.abstract }}</p>
          <div v-if="page.content">{{ page.content }}</div>
          <div v-else>
    ...
    <AppSection class="section--shade" title="More Stories" url="/blog/">
